      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="lg:row-span-2">
          ...
          <div className="p-6 space-y-8">
            <div className="space-y-4">
              <h4 className="text-xs font-black text-slate-400 uppercase tracking-wider">Communication Methods</h4>
              ...
              <div className="flex justify-between items-center">
               ...
               <div className="pt-2">
                <label className="block text-xs font-bold text-slate-400 uppercase mb-2">Email Frequency</label>
                <Select 
                  options={[
            ...
            <div className="pt-6 border-t border-slate-50 space-y-4">
              <h4 className="text-xs font-black text-slate-400 uppercase tracking-wider">Subscription Topics</h4>
               <div className="flex justify-between items-center">
        ...
        <Card>
          ...
          <div className="p-6 space-y-6">
            <div>
              <label className="block text-xs font-bold text-slate-400 uppercase mb-3">Profile Visibility</label>
              <div className="flex flex-col gap-2">
                {[
                  ...
                  <label key={level.id} className={`flex items-start p-3 rounded-xl border cursor-pointer transition-all ${prefs.privacyLevel === level.id ? 'bg-emerald-50 border-emerald-200 ring-1 ring-emerald-500/20' : 'bg-white border-slate-200 hover:border-slate-300'}`}>
                    <input 
                      type="radio" 
                      name="privacy" 
                      className="mt-1"
